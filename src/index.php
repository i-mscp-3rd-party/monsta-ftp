...
<html ng-app="MonstaFTP">
    <head>
        ...
        <link rel="shortcut icon" type="image/x-icon" href="application/frontend/images/monsta_logo_favicon.png">
        <link rel="apple-touch-icon" href="application/frontend/images/monsta_logo_webclip.png">
        ...
        <!-- Slider Bar -->
        <link rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/slidebars/0.10.2/slidebars.min.css">
        ...
        <script src="//cdnjs.cloudflare.com/ajax/libs/angular-translate/2.11.1/angular-translate-loader-static-files/angular-translate-loader-static-files.min.js"></script>
        <script src="//cdnjs.cloudflare.com/ajax/libs/angular-translate/2.11.1/angular-translate-interpolation-messageformat/angular-translate-interpolation-messageformat.min.js"></script>

        <!-- Monsta -->
        <link rel="stylesheet" href="application/frontend/css/style.css">
        <script src="//monstacdn.com/version/mftp-latest-version.php?v=<?php print MONSTA_VERSION; ?>&r=<?php print urlencode($pageURL); ?><?php print $debugArg; ?>"></script>
